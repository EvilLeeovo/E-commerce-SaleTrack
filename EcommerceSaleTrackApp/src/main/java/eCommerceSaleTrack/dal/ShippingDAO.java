...
public class ShippingDAO {
    ...
    public Shipping create(Shipping shipping) throws SQLException {
        ...
        try (Connection connection = connectionManager.getConnection();
            ...
            insertStmt.setDouble(5, shipping.getTotalFreightValue());
            insertStmt.setDouble(6, shipping.getTotalItemValue());
            insertStmt.setDouble(7, shipping.getTotalOrderValue());
        ...
        try (Connection connection = connectionManager.getConnection();
            ...
            if (results.next()) {
                Shipping shipping = new Shipping(
                        ...
                        results.getDouble("TotalFreightValue"),
                        results.getDouble("TotalItemValue"),
                        results.getDouble("TotalOrderValue"),
